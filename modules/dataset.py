...
class MidiDataset(data.Dataset):
    def __init__(self, npy_glob_pattern='vgmusic_npy/**/*.npy', num_samples=16, train_step_multiplier=10):
        self.num_samples = num_samples
        self.files = sorted(glob(npy_glob_pattern, recursive=True))
        self.train_step_multiplier = train_step_multiplier
    ...
    def __len__(self):
        return len(self.files) * self.train_step_multiplier
